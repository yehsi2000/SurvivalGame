...
public:	
	...
	//"BlueprintImplementableEvent" c++에서 선언되고 blueprint에서 implement
	UFUNCTION(BlueprintImplementableEvent)
	void AlignWithGround();

	// This is used as a template to create the pickup when spawned in
	// Instanced + EditInlineNew(in item.h) => lets editor construct new item
...
protected:
	...
	/** If some property on the item is modifiedm we bind this to OnItemModified and refresh the UI if the item gets modified */
	UFUNCTION()
	void OnItemModified();
